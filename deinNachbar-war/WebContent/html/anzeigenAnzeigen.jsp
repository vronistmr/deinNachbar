...
<!-- Tobi -->
	...
	<article>
		<div class="preis">
			...
			<c:if test="${AnzeigeForm.preiskategorie != 'Gratis'}">
				<span>${AnzeigeForm.preis} € ${AnzeigeForm.preiskategorie}</span>
				<br />
			</c:if>
		</div>
		<br />
		...
		<p class="blocksatz">
			<span class="fett">${AnzeigeForm.standort} und im Umkreis von
				${AnzeigeForm.umkreis} Kilometern</span>
		</p>
		<br>
		<p class="blocksatz">
			Anzeige veröffentlicht von <span class="fett">${AnzeigeForm.vorname}</span><br />
			<br />
		</p>
	</article>
...
<!-- Lukas -->
	<div class="unten">
		<c:if
			...
			<a href="./../ServletAnzeigeBuchen?id=${AnzeigeForm.anzeigeID}"
				class="button">Buchen</a>
		</c:if>
		<c:if
			test="${AnzeigeForm.gebucht || loginForm.istAdmin && AnzeigeForm.benutzerID != loginForm.benutzerID}">
		...
		<c:if test="${AnzeigeForm.gebucht}">
			<a
				href="./../ServletBuchungLoeschen?anzeigeID=${AnzeigeForm.anzeigeID}"
				class="button buchungLoeschen">Buchung löschen</a>
		</c:if>
