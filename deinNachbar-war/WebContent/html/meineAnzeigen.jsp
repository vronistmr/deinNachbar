			...
			<div class="anzeigeBox">
				...
				<c:if test="${currentAnzeige.preiskategorie != 'Gratis'}">
					<span>${currentAnzeige.preis} €
						${currentAnzeige.preiskategorie}</span>
					<br />
				</c:if>
				<span>${currentAnzeige.standort}</span><br /> <br /> <span><a
					href="./../ServletAnzeigeAnzeigen?anzeigeid=${currentAnzeige.anzeigeID}"
					class="button">Zur Anzeige</a></span><br />
			</div>
		</c:forEach>
	</main>
</div>
