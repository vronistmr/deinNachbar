...
public class ServletKategorieLoeschen extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		// KategorieId und kategorie von zu gelöschter Kategorie aus QS lesen! Dafür
		// müssen dem Button "Löschen" auf der Startseite die Id und die jeweilige
		// kategorie übergeben werden!
	...
	private void delete(int kategorieId, String kategorie) throws ServletException {
		...
		try (Connection con = ds.getConnection();
				PreparedStatement pstmt = con.prepareStatement(
						"DELETE FROM gebuchte WHERE gebuchte.anzeigeID IN(SELECT anzeige.anzeigeID FROM kategorie JOIN anzeige ON anzeige.kategorie = kategorie.kategorie WHERE kategorie.kategorieID = ?)")) {
